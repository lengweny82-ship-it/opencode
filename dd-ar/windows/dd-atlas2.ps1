...
Log "Double Dealers - font picture extractor  (v2)"
...
if ($bytes) {
  ...
  try {
    ...
    $w = [int](LE32 $bytes ($texStart + 40))
    $h = [int](LE32 $bytes ($texStart + 44))
    $imgSize = [int](LE32 $bytes ($texStart + 48))
    ...
    $cropText = "dot,670,405,23,23|comma,793,1684,23,40|excl,1468,548,23,93|ell,1374,1561,36,94|o,1623,866,68,67|A,1131,672,93,94|S,1379,563,74,94|g,1623,761,68,90|udiaeresis,743,1909,61,96|W,868,1453,136,94|x,1963,1878,60,65|colon,1990,279,23,65"
