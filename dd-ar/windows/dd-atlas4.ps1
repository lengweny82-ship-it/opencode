...
Log "Double Dealers - font picture sampler  (v4)"
...
if ($bytes) {
  ...
  try {
    ...
    $cropText = "win1,1536,1472,512,512|win2,1100,500,512,512"
...
Log ""
Log ("file written : " + $txt.Length + " chars  (" + $made + " windows)")
